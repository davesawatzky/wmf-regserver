...
var canUserMutateInfo_1 = require("../../../utils/canUserMutateInfo");
var SGSlabel;
(function (SGSlabel) {
    SGSlabel["SOLO"] = "SOLO";
...
exports.RegistrationMutations = {
    registrationCreate: function (_, _a, _b) {
        var performerType = _a.performerType;
    ...
    registrationUpdate: function (_, _a, _b) {
        var registrationID = _a.registrationID, registration = _a.registration;
        var db = _b.db, userInfo = _b.userInfo;
        return __awaiter(void 0, void 0, void 0, function () {
            var error, existingRegistration;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!userInfo) {
    ...
    registrationDelete: function (_, _a, _b) {
        var id = _a.id;
        var db = _b.db, userInfo = _b.userInfo;
        return __awaiter(void 0, void 0, void 0, function () {
